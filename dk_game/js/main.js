...
var GameState = {
    ...
    preload: function () {
        ...
        this.load.spritesheet('hammer','assets/images/hammer_spritesheet1.png',23,36,3);
    },
    ...
    create: function () {
        ...
        this.hammer=this.add.sprite(100, 500, 'hammer');
        this.hammer.animations.add('hammer');
        this.hammer.anchor.setTo(0,0.5);
    ...
    update: function () {
        ...
        if(this.player.customParams.isHoldHammer){
            ...
            this.game.physics.arcade.overlap(this.hammer,this.barrels,this.KillBarrel);
        }
        else{
            //collision detection with hammer and barrel in order to pick hammer
            this.game.physics.arcade.overlap(this.player,this.hammer,this.PickUpHammer);
        }
        ...
        if(this.player.customParams.isHoldHammer){
            ...
            if(this.player.customParams.isFacingLeft){
                this.hammer.body.x=this.player.body.x-30;
                this.hammer.body.y=this.player.body.y-10;
                this.hammer.anchor.setTo(0,0.5);
                this.hammer.scale.setTo(1,1);
            }
